...
Лабораторная работа № 15 - Многофазная и естественная сортировки
...
## Тест 1, arraySize = 30, Multiphase Sort
...
## Тест 2, arraySize = 30, Natural Sort
...
## Тест 3, arraySize = 30, Natural Sort
