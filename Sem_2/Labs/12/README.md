...
Лабораторная работа № 12 - Сортировки
...
## Тест 1, arraySize = 10, Bucket sort
...
## Тест 2, arraySize = 10, Counting sort
...
## Тест 3, arraySize = 10, Merge sort
...
## Тест 4, arraySize = 10, Quick sort
